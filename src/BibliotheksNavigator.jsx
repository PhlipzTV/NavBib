...
const SEED = {
  ...
  bereiche: [
    ...
    { id: "b02", name: "Zeitschriften & Bestseller", etageId: "e0", x: 22, y: 55 },
    { id: "b03", name: "Ausleihe & Rückgabe", etageId: "e0", x: 78, y: 50 },
    { id: "b04", name: "Café", etageId: "e0", x: 8, y: 62 },
    { id: "b05", name: "Kinderbibliothek", etageId: "e1", x: 15, y: 30 },
    { id: "b06", name: "Michael-Ende-Kabinett", etageId: "e1", x: 32, y: 35 },
    { id: "b07", name: "Jugendbibliothek", etageId: "e1", x: 50, y: 65 },
    { id: "b08", name: "Gaming-Room", etageId: "e1", x: 68, y: 30 },
    { id: "b09", name: "Non-Book-Bereich", etageId: "e1", x: 85, y: 60 },
    { id: "b10", name: "Romane A–H", etageId: "e2", x: 15, y: 30 },
    { id: "b11", name: "Romane I–R", etageId: "e2", x: 30, y: 28 },
